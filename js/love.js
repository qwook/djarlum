...
(function() {
  var Audio, Canvas, Color, EventQueue, FileSystem, Font, Graphics, Image, ImageData, Keyboard, Mouse, Quad, Source, Timer, Window, determineFontHeight,
  ...
  Mouse = (function() {
    function Mouse() {
      ...
      this.setGrab = __bind(this.setGrab, this);
    ...
    Mouse.prototype.setGrab = function() {};

    Mouse.prototype.setGrabbed = function() {};
